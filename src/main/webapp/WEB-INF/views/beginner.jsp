...
<body>
<div class="container-fluid navbar-fixed-top top-nav">
...
<div class="container">
    ...
    <div class="col-md-8">
        <div class="row">
            <h3><img src="../../resources/images/menu-photo.6.jpg" style=" width:45px; height: 45px; margin: 10px;"> All
                Lessons
            </h3>
        </div>
        <div class="row" style="padding-bottom: 100px">
            <div class="col-md-3 pol-beginner-topics" id="pol-topic-1">
                ...
                <img class="img-responsive pol-beginner-t-img" src="../../resources/images/menu-photo.6.jpg"
                     alt="img">
            </div>
            ...
            <div class="col-md-3 pol-beginner-topics" id="pol-topic-3">
                ...
                <img class="img-responsive pol-beginner-t-img" src="../../resources/images/menu-photo6.jpg"
                     alt="img">
            </div>
        ...
        <div class="row" style="padding-bottom: 80px;">
            <div id="jssor_1"
                ...
                <div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
                    ...
                    <div style="position:absolute;display:block;background:url('../../resources/images/images_beginner/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
                </div>
                <div data-u="slides"
                    ...
                    <div data-p="112.50" style="display: none;">
                        <img data-u="image" src="../../resources/images/images_beginner/009.jpg"/>
                    ...
                    <div data-p="112.50" style="display: none;">
                        <img data-u="image" src="../images/images_beginner/006.jpg"/>
                    ...
                    <div data-p="112.50" style="display: none;">
                        <img data-u="image" src="../images/images_beginner/009.jpg"/>
                    ...
                    <div data-b="0" data-p="112.50" style="display: none;">
                        <img data-u="image" src="../images/images_beginner/008.jpg"/>
                    ...
                    <div data-p="112.50" style="display: none;">
                        <img data-u="image" src="../images/images_beginner/011.jpg"/>
                    ...
                    <div data-p="112.50" style="display: none;">
                        <img data-u="image" src="../images/images_beginner/010.jpg"/>
                        ...
                        <div data-u="caption" data-t="10" data-3d="1"
                            ...
                            <div style="margin: 15px; font-size: 20px;">
                                ...
                                <img src="../images/images_beginner/icon_chrome.png"/> here.
...
<div id="footer" class="container-fluid footer">
    <div class="col-md-6 col-sm-12  col-lg-offset-3">
        ...
        <div id="footerText">
            ...
            <p style="padding-top: 2%"><i class="fa fa-copyright" aria-hidden="true"></i>2016 Bright
                Future
                Inc.
                All
                rights reserved.</p>

            <p>Terms, conditions, features, availability, pricing, fees, service and support options
                subject
                to
                change
                without notice</p>
